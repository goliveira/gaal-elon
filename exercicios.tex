...
(b)
Procedendo como no item (a), obtemos à equação $4x - 4y + 10z = -20$.

(c)
Procedendo como no item (a), obtemos à equação $2x + 2y + 2z = 18$.

(d)
Procedendo como no item (a), obtemos à equação $(x_2 - x_1)x + (y_2 - y_1)y + (z_2 - z_1)z = (x_2 - x_1)x_0 + (y_2 - y_1)y_0 + (z_2 - z_1)z_0$.
