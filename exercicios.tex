...
\[
  u = \left( \frac{2 - \sqrt{5}}{\sqrt{10 - 2\sqrt{5}}}, \frac{1}{\sqrt{10 - 2\sqrt{5}}} \right), \qquad u^* = \left( \frac{-1}{\sqrt{10 - 2\sqrt{5}}}, \frac{2 - \sqrt{5}}{\sqrt{10 - 2\sqrt{5}}} \right).
\]
Consequentemente, efetuando a mudança de variáveis
\begin{align*}
  x & = u_1 s - u_2 t, \\
  y & = u_2 s + u_1 t,
\end{align*}
...
Nesse caso, temos $c = 2/\sqrt{\sqrt{5}}$ e portanto os focos são $(-c,0)$ e $(c,0)$, no sistema $s$ e $t$.
Em termos das coordenadas $x$ e $y$, os focos são
\[
  \left( \frac{2 \sqrt{5} - 4}{\sqrt{10 \sqrt{5} - 10}}, \frac{-2}{\sqrt{10 \sqrt{5} - 10}} \right), \qquad \left( \frac{4 - 2 \sqrt{5}}{\sqrt{10 \sqrt{5} - 10}}, \frac{2}{\sqrt{10 \sqrt{5} - 10}} \right).
\]
