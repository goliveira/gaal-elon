...
Prove que as retas $AP$, $BP$, $CP$ são medianas de $ABC$, logo $P$ é o ba\-ri\-cen\-tro desse triângulo.
...
Para $d = 1$, temos uma elipse com $c^2 = a^2 + b^2$, ou seja, $c = 2 \sqrt{2/3}$, e portanto os focos da elipse são $(-c,0)$ e $(c,0)$, no sistema $s$ e $t$.
Em termos das coordenadas $x$ e $y$, os focos são, respectivamente,
\[
  \left( -\frac{2}{\sqrt{3}}, -\frac{2}{\sqrt{3}} \right), \qquad \left( \frac{2}{\sqrt{3}}, \frac{2}{\sqrt{3}} \right).
\]
...
\]
Para $d < 0$, as linhas de nível $\overline{\varphi}(s,t) = d$ são o conjunto vazio.
Para $d = 0$, a linha de nível $\overline{\varphi}(s,t) = d$ é uma reta horizontal que passa pela origem.
Para $d > 0$, as linhas de nível $\overline{\varphi}(s,t) = d$ são um par de retas horizontais.
...
\]
Para $d = 0$, as linhas de nível $\overline{\varphi}(s,t) = d$ são as retas $t = s$ e $t = -s$.
Para $d \neq 0$, as linhas de nível $\overline{\varphi}(s,t) = d$ são hipérboles.
Para $d = 1$, temos uma hipérbole com $c^2 = a^2 + b^2$, ou seja, $c = 2/\sqrt{\sqrt{5}}$, e portanto os focos da hipérbole são $(-c,0)$ e $(c,0)$, no sistema $s$ e $t$.
Em termos das coordenadas $x$ e $y$, os focos são, respectivamente,
\[
